...
//public class MemberReviewController2 {
//
//    private final MemberReviewService2 memberReviewService2;
...
//        ReviewCreateResponse response = memberReviewService2.registerReview(reviewCreateRequest);
...
//        ReviewUpdateResponse response = memberReviewService2.updateReview(
//            reviewUpdateRequest);
//        return new ResponseEntity<>(response, HttpStatus.OK);
//    }
//
...
//        memberReviewService2.deleteReviewAndComment(reviewId);
